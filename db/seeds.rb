...
User.create(email: 'wagon@yopmail.com', password: 'motdepasse', is_admin: 'true', first_name: 'wagon', last_name: 'wagon', is_school: true)
User.create(email: 'oclock@yopmail.com', password: 'motdepasse', is_admin: 'true', first_name: 'oclock', last_name: 'oclock', is_school: true)
User.create(email: 'educatel@yopmail.com', password: 'motdepasse', is_admin: 'true', first_name: 'educatel', last_name: 'educatel', is_school: true)
...
7.times do |i|
  School.create(name: school_array[i][:name], website: school_array[i][:website], siret: school_array[i][:siret], campus_nb: school_array[i][:campuses], creation_year: school_array[i][:creation], logo_url: school_array[i][:logo_url], user_id: school_array[i][:user_id])
end
